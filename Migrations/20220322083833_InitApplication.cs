        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShowText = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppFile_AspNetUsers_UploaderId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreateTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Texts = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<long>(type: "bigint", nullable: false),
                    ReplyToArticleId = table.Column<long>(type: "bigint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<long>(type: "bigint", nullable: false),
                    FavouriteArticleId = table.Column<long>(type: "bigint", nullable: true),
                    FavouriteUserId = table.Column<long>(type: "bigint", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserFavourites", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserFavourites_Articles_FavouriteArticleId",
                        column: x => x.FavouriteArticleId,
                        principalTable: "Articles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserFavourites_AspNetUsers_FavouriteUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CommentUsers_Articles_ArticleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommentUsers_ArticleId",
                table: "CommentUsers",
                column: "ArticleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserFavourites_FavouriteArticleId",
                table: "UserFavourites",
                column: "FavouriteArticleId");

            migrationBuilder.CreateIndex(
                name: "IX_UserFavourites_FavouriteUserId",
                table: "UserFavourites",
