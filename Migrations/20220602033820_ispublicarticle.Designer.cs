...
namespace MyWeb.Migrations
{
    ...
    [Migration("20220602033820_ispublicarticle")]
    partial class ispublicarticle
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyWeb.Models.ArticleTag", b =>
                {
            ...
            modelBuilder.Entity("MyWeb.Models.ChatMessage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("MyWeb.Models.Comment", b =>
                {
                    ...
                    b.Property<long?>("BelongToCommentId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("MyWeb.Models.ExamineRecord", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("MyWeb.Models.RecentChat", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("MyWeb.Models.SearchRecord", b =>
                {
            ...
            modelBuilder.Entity("MyWeb.Models.SystemNotify", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("SystemNotifies");
                });

            modelBuilder.Entity("MyWeb.Models.Tag", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("MyWeb.Models.ArticleTag", b =>
                {
                    b.HasOne("MyWeb.Models.Article", null)
                        .WithMany("Tags")
                        .HasForeignKey("ArticleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MyWeb.Models.Tag", null)
                        .WithMany("Articles")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MyWeb.Models.ChatMessage", b =>
                {
                    b.HasOne("MyWeb.Models.MyUser", "Reciever")
                        .WithMany("RecievedMessages")
                        .HasForeignKey("RecieverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MyWeb.Models.MyUser", "Sender")
            ...
            modelBuilder.Entity("MyWeb.Models.Comment", b =>
                {
                    b.HasOne("MyWeb.Models.Comment", "BelongToComment")
                        .WithMany("UnderComments")
                        .HasForeignKey("BelongToCommentId");
            ...
            modelBuilder.Entity("MyWeb.Models.ExamineRecord", b =>
                {
                    ...
                    b.HasOne("MyWeb.Models.MyUser", "Examiner")
                        .WithMany("ExamineRecords")
            ...
            modelBuilder.Entity("MyWeb.Models.MyUser", b =>
                {
                    b.OwnsOne("MyWeb.Models.UserLastActivity", "LastActivity", b1 =>
                        {
                            b1.Property<long>("MyUserId")
                                .HasColumnType("bigint");

                            b1.Property<DateTime>("ArticleTime")
                                .HasColumnType("datetime2");

                            b1.Property<DateTime>("NotifyTime")
                                .HasColumnType("datetime2");

                            b1.Property<DateTime>("ReplyTime")
                                .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("MyWeb.Models.RecentChat", b =>
                {
                    b.HasOne("MyWeb.Models.MyUser", "ChatToUser")
                        .WithMany("RecentBeChats")
                        .HasForeignKey("ChatToUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MyWeb.Models.MyUser", "User")
                        .WithMany("RecentChats")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ChatToUser");
            ...
            modelBuilder.Entity("MyWeb.Models.Article", b =>
                {
                    b.Navigation("BeExaminedRecords");
            ...
            modelBuilder.Entity("MyWeb.Models.MyUser", b =>
                {
                    ...
                    b.Navigation("ExamineRecords");

                    b.Navigation("FavouriteUser");

                    b.Navigation("Favourites");

                    b.Navigation("RecentBeChats");

                    b.Navigation("RecentChats");

                    b.Navigation("RecievedMessages");

                    b.Navigation("SystemNotify");
